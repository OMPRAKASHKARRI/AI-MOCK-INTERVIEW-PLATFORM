...
function HomePage() {
  ...
  const [recentInterviews, setRecentInterviews] =
    useState([])
  const [allInterviews, setAllInterviews] =
    useState([])
    ...
    <div className="home-page">
      <div className="home-welcome">
        ...
        <p className="home-welcome-subtitle">
          Practice makes perfect. Start a mock
          interview and get AI-powered feedback.
        </p>
      </div>
      ...
      <div className="home-recent-section">
        ...
        {loading ? (
          ...
          <div className="home-empty-state">
            ...
            <h3 className="home-empty-heading">
              No interviews yet
            </h3>
